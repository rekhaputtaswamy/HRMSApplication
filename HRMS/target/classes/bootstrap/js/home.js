...
function modifyProfile() {
	...
	$("#employement_drop").val($("#employement_type").val());
	$("#employement_drop").show();
	
	$("#gender").hide();
	$("#gender_drop").val($("#gender").val());
	$("#gender_drop").show();
	
	$("#dob").hide();
	$("#dob_input").val($("#dob").val());
	$("#dob_input").show();
	$('#dob_datePicker').show();

    $("#doj").hide();
    $("#doj_input").val($("#doj").val());
    $("#doj_input").show();
    $('#doj_datePicker').show();

    $("#start_date").hide();
    $("#start_date_input").val($("#start_date").val());
    $("#start_date_input").show();
    $('#start_date_datePicker').show();

    $("#end_date").hide();
    $("#end_date_input").val($("#end_date").val());
    $("#end_date_input").show();
...
function saveValues() {
	if(localStorage.getItem("emp_number") == "" || localStorage.getItem("emp_number") === null || $('#emp_number').val() == localStorage.getItem("emp_number")) {
		...
		localStorage.setItem("gender_drop", $('#gender_drop').val());
		localStorage.setItem("dob_input", $('#dob_input').val());
		localStorage.setItem("doj_input", $('#doj_input').val());
		localStorage.setItem("department_list", $('#department_list').val());
		localStorage.setItem("employement_drop", $('#employement_drop').val());
		localStorage.setItem("start_date_input", $('#start_date_input').val());
		localStorage.setItem("end_date_input", $('#end_date_input').val());
	}
...
function clearLocalStorage() {
	...
	localStorage.setItem("gender_drop", "");
	localStorage.setItem("dob_input", "");
	localStorage.setItem("doj_input", "");
	localStorage.setItem("department_list", "");
	localStorage.setItem("employement_drop", "");
	localStorage.setItem("start_date_input", "");
	localStorage.setItem("end_date_input", "");
}
...
function restoreValues() {
	...
	$('#gender_drop').val(localStorage.getItem("gender_drop"));
	$('#dob_input').val(localStorage.getItem("dob_input"));
	$('#doj_input').val(localStorage.getItem("doj_input"));
	$('#department_list').val(localStorage.getItem("department_list"));
	$('#employement_drop').val(localStorage.getItem("employement_drop"));
	$('#start_date_input').val(localStorage.getItem("start_date_input"));
	$('#end_date_input').val(localStorage.getItem("end_date_input"));
